...
All=['Pizarra','Alora','Alamo',"Lomas",'Torrox','Centro','Fuengirola','Prados','Lima','PlazaMayor',"David",'Col']
All.sort()
Line_Check={'Pizarra':1,'Alora':1,'Alamo':1,"Lomas":1,'Torrox':1,'Centro':1,'Fuengirola':2,'Prados':2,'Lima':2,'PlazaMayor':2,"David":2,'Col':2}
FARES=[[0 for i in range (12)] for j in range(12)]
def getLine(station):
